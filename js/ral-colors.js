const ralColors = [
    ...
    { code: 'RAL 4012', name: 'Pearl black berry', hex: '#6C6874' },
    ...
    { code: 'RAL 5003', name: 'Saphire blue', hex: '#1D1E33' },
...
if (typeof document !== 'undefined') {
    ['ral-select', 'catalog-ral-select'].forEach(function (id) {
        const select = document.getElementById(id);
        if (select) {
            select.innerHTML = '';
            const placeholder = document.createElement('option');
            placeholder.value = '';
            placeholder.textContent = '-- Оберіть RAL --';
            select.appendChild(placeholder);
            ralColors.forEach(function (c) {
...
if (typeof module !== 'undefined' && module.exports) { module.exports = ralColors; }